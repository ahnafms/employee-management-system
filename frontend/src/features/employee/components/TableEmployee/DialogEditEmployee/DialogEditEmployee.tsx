...
export interface DialogEditEmployeeProps {
  onSuccess?: () => void;
}

export const DialogEditEmployee = forwardRef<
  DialogEditEmployeeRef,
  DialogEditEmployeeProps
>(function DialogEditEmployee({ onSuccess }, ref) {
  const {
    open,
    editForm,
    isLoading,
    ...
    updateForm,
    handleSubmit,
  } = useDialogEditEmployee({ onSuccess });
